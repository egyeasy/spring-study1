...
import com.spring.study1.springboot.domain.posts.Posts;
import com.spring.study1.springboot.domain.posts.PostsRepository;
import com.spring.study1.springboot.web.dto.PostsListResponseDto;
...
public class PostsService {
    ...
    public PostsResponseDto findById(Long id) {
        Posts entity = postsRepository.findById(id)
                .orElseThrow(() -> new IllegalArgumentException("해당 게시글일 없습니다. id=" + id));
